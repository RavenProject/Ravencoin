...
class TestChickadeeCli(ChickadeeTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from `chickadee-cli -getinfo` and the RPCs data is retrieved from.")
