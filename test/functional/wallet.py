...
class WalletTest(ChickadeeTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 x16rc from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 x16rc with subtract fee from amount
        ...
        # Sendmany 10 x16rc with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/lukepighetti/x16rc/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
