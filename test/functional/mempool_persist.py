...
By default, chickadeed will dump mempool on shutdown and
...
class MempoolPersistTest(ChickadeeTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give chickadeed a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent chickadeed from writing mempool.dat to disk. Verify that `savemempool` fails")
