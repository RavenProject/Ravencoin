...
By default, yottafluxd will dump mempool on shutdown and
...
class MempoolPersistTest(YottafluxTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give yottafluxd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent yottafluxd from writing mempool.dat to disk. Verify that `savemempool` fails")
