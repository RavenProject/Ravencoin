...
# TestNode: A peer we use to send messages to chickadeed, and store responses.
...
class CompactBlocksTest(ChickadeeTestFramework):
    ...
    # This test actually causes chickadeed to (reasonably!) disconnect us, so do this last.
    ...
    # Test that chickadeed requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for chickadeed to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # chickadeed will not send blocktxn responses for blocks whose height is
