...
MNEMONIC_0 = 'puma árbol trago pálido oruga fibra candil jurar humano archivo envase capaz'
MNEMONIC_PASS_0 = 'test0'
MNEMONIC_1 = 'untar puerta rito manta audaz copa nácar agregar ligero lucha llenar hígado'
...
class Bip44Test(RavenTestFramework):
    ...
    def run_test(self):
        ...
        for i in range(0, 12):
            ...
            #assert_contains(word_list_3[i], bip39_spanish)
