...
class TxnMallTest(ChickadeeTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 x16rc:
        ...
        # First: use raw transaction API to send 1240 x16rc to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 x16rc coin each
        ...
        # Node0's balance should be starting balance, plus 50x16rc for another
        ...
        # Node0's total balance should be starting balance, plus 100x16rc for 
