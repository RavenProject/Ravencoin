...
class BIP66Test(YottafluxTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # yottafluxd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and yottafluxd produces more specific reject
            # reasons.
