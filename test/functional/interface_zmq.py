...
import os
import struct
from test_framework.test_framework import YottafluxTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(YottafluxTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that yottaflux has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("yottafluxd has not been built with zmq enabled.")
