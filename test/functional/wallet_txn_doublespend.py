...
class TxnMallTest(YottafluxTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 YAI:
        ...
        # First: use raw transaction API to send 1240 YAI to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 YAI coin each
        ...
        # Node0's balance should be starting balance, plus 50YAI for another
        ...
        # Node0's total balance should be starting balance, plus 100YAI for 
