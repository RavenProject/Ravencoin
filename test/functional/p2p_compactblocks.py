...
# TestNode: A peer we use to send messages to yottafluxd, and store responses.
...
class CompactBlocksTest(YottafluxTestFramework):
    ...
    # This test actually causes yottafluxd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that yottafluxd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for yottafluxd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # yottafluxd will not send blocktxn responses for blocks whose height is
