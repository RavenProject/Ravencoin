Yottaflux Core version *2.2.2* is now available!!
==============

  <https://github.com/yottaflux/Yottaflux/releases/tag/v2.2.2>
...
- Enhancements for Yottaflux Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/yottaflux/Yottaflux/commits/release_2.2.2>
