Yottaflux Core version *2.1.0* is now available!!
==============

  <https://github.com/yottaflux/Yottaflux/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/yottaflux/Yottaflux/commits/release_2.1.0>
