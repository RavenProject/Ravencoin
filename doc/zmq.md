...
during the *configure* step of building yottafluxd:
...
These options can also be provided in yottaflux.conf.
...
From the perspective of yottafluxd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into yottafluxd directly. Furthermore, no information is
...
using. Yottafluxd appends an up-counting sequence number to each
