...
This document provides guidelines for internationalization of the Chickadee Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `chickadee_en.ts` remains unchanged.
