...
This document provides guidelines for internationalization of the Yottaflux Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `yottaflux_en.ts` remains unchanged.
