...
Yottaflux Core version *version* is now available from:

  <https://yottaflux.ai/bin/yottaflux-core-*version*/>
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/yottaflux/).
