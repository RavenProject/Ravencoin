...
By default, yottaflux-core allows up to 125 connections to different peers, 12 of
...
limits are tiny. Keep in mind that yottaflux's trustless model works best if you are
