...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler yai tx
        CScript yaiTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut yaiOut(1*COIN, yaiTransfer);
        ...
        mutTxTest1.vout.emplace_back(yaiOut);
        ...
        mutTxTest2.vout.emplace_back(yaiOut);
        ...
        mutTxTest3.vout.emplace_back(yaiOut);
        ...
        mutTxTest4.vout.emplace_back(yaiOut);
        ...
        mutTxTest5.vout.emplace_back(yaiOut);
        ...
        mutTxTest6.vout.emplace_back(yaiOut);
        ...
        mutTxTest7.vout.emplace_back(yaiOut);
        ...
        mutTxTest8.vout.emplace_back(yaiOut);
