...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "issue", 5, "reissuable" },
    { "issue", 6, "has_ipfs" },
    { "issuerestricted", 1, "qty" },
    { "issuerestricted", 5, "units" },
    { "issuerestricted", 6, "reissuable" },
    { "issuerestricted", 7, "has_ipfs" },
    { "reissuerestricted", 1, "qty" },
    { "reissuerestricted", 3, "change_verifier" },
    { "reissuerestricted", 6, "new_unit" },
    { "reissuerestricted", 7, "reissuable" },
    ...
    { "transferqualifierasset", 2, "qty"},
    { "transferqualifierasset", 5, "expire_time"},
    { "reissue", 1, "qty"},
