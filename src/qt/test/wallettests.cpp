...
#include "qt/chickadeeamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<ChickadeeAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_chickadee-qt -platform xcb      # Linux
//     src/qt/test/test_chickadee-qt -platform windows  # Windows
//     src/qt/test/test_chickadee-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = ChickadeeUnits::formatWithUnit(unit, balance, false, ChickadeeUnits::separatorAlways);
    ...
    // Amount input
    ChickadeeAmountField* amountInput = receiveCoinsDialog.findChild<ChickadeeAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: chickadee:")) != -1);
