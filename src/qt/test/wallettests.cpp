...
#include "qt/yottafluxamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<YottafluxAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_yottaflux-qt -platform xcb      # Linux
//     src/qt/test/test_yottaflux-qt -platform windows  # Windows
//     src/qt/test/test_yottaflux-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = YottafluxUnits::formatWithUnit(unit, balance, false, YottafluxUnits::separatorAlways);
    ...
    // Amount input
    YottafluxAmountField* amountInput = receiveCoinsDialog.findChild<YottafluxAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: yottaflux:")) != -1);
