...
#ifndef CHICKADEE_QT_GUIUTIL_H
#define CHICKADEE_QT_GUIUTIL_H
...
/** Utility functions used by the Chickadee Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "chickadee:" URI into recipient object, return true on successful parsing
