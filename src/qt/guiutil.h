...
#ifndef YOTTAFLUX_QT_GUIUTIL_H
#define YOTTAFLUX_QT_GUIUTIL_H
...
/** Utility functions used by the Yottaflux Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "yottaflux:" URI into recipient object, return true on successful parsing
