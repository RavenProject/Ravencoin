...
#ifndef CHICKADEE_QT_CHICKADEEUNITS_H
#define CHICKADEE_QT_CHICKADEEUNITS_H
...
/** Chickadee unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ChickadeeUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ChickadeeUnits(QObject *parent);

    /** Chickadee units.
      @note Source: https://en.chickadee.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        X16RC,
...
typedef ChickadeeUnits::Unit ChickadeeUnit;

#endif // CHICKADEE_QT_CHICKADEEUNITS_H
