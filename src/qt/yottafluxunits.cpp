...
QString YottafluxUnits::name(int unit)
{
    switch(unit)
    {
    case YAI: return QString("YAI");
    case mYAI: return QString("mYAI");
    case uYAI: return QString::fromUtf8("μYAI");
...
qint64 YottafluxUnits::factor(int unit)
{
    switch(unit)
    {
    case YAI:  return 100000000;
    case mYAI: return 100000;
    case uYAI: return 100;
