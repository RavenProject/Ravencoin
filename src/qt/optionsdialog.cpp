    ...
    mapper(0)
{
    ...
    ui->yottafluxAtStartup->setToolTip(ui->yottafluxAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->yottafluxAtStartup->setText(ui->yottafluxAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openYottafluxConfButton->setToolTip(ui->openYottafluxConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new YottafluxUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->yottafluxAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openYottafluxConfButton_clicked()
{
