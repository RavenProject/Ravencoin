...
#include "config/yottaflux-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatYottafluxURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + YottafluxUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatYottafluxURI(info));
}
