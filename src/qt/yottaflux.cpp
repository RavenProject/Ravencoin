...
/** Class encapsulating Yottaflux startup and shutdown.
 * Allows running startup and shutdown in a different thread from the UI thread.
 */
class Yottaflux: public QObject
{
    Q_OBJECT
public:
    explicit Yottaflux();
...
void Yottaflux::handleRunawayException(const std::exception *e)
{
    PrintExceptionContinue(e, "Runaway exception");
    Q_EMIT runawayException(QString::fromStdString(GetWarnings("gui")));
}

bool Yottaflux::baseInitialize()
{
...
void Yottaflux::restart(QStringList args)
{
...
void YottafluxApplication::startThread()
{
    ...
    Yottaflux *executor = new Yottaflux();
