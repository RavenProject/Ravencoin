...
bool AtomicSwapsDialog::eventFilter(QObject *sender, QEvent *event)
{
...
void AtomicSwapsDialog::setupCoinControlFrame(const PlatformStyle *platformStyle)
{
...
void AtomicSwapsDialog::setupAssetDataView(const PlatformStyle *platformStyle)
{
...
void AtomicSwapsDialog::setupFeeControl(const PlatformStyle *platformStyle)
{
...
void AtomicSwapsDialog::toggleIPFSText()
{
...
void AtomicSwapsDialog::showInvalidVerifierStringMessage(QString string)
{
...
void AtomicSwapsDialog::hideInvalidVerifierStringMessage()
{
...
bool AtomicSwapsDialog::checkIPFSHash(QString hash)
{
    if (!hash.isEmpty()) {
        std::string error;
...
/** SLOTS */
void AtomicSwapsDialog::ipfsStateChanged()
{
    toggleIPFSText();
}

void AtomicSwapsDialog::checkAvailabilityClicked()
{
    QString name = GetAssetName();
...
void AtomicSwapsDialog::onNameChanged(QString name)
{
...
void AtomicSwapsDialog::onAddressNameChanged(QString address)
{
    CheckFormState();
}

void AtomicSwapsDialog::onVerifierStringChanged(QString verifier)
{
    CheckFormState();
}

void AtomicSwapsDialog::onIPFSHashChanged(QString hash)
{
    if (checkIPFSHash(hash))
        CheckFormState();
}

void AtomicSwapsDialog::onCreateAssetClicked()
{
...
void AtomicSwapsDialog::onUnitChanged(int value)
{
    QString text;
    text += "e.g. 1";
    // Add the period
...
void AtomicSwapsDialog::onChangeAddressChanged(QString changeAddress)
{
    CheckFormState();
}

void AtomicSwapsDialog::onAssetTypeActivated(int index)
{
    disableCreateButton();
    checkedAvailablity = false;
...
void AtomicSwapsDialog::onAssetListActivated(int index)
{
    // Get the identifier for the asset type
    QString identifier = GetSpecialCharacter();
...
void AtomicSwapsDialog::updatePresentedAssetName(QString name)
{
    ui->assetFullName->setText(name);
}

QString AtomicSwapsDialog::GetSpecialCharacter()
{
...
QString AtomicSwapsDialog::GetAssetName()
{
    if (type == IntFromAssetType(AssetType::ROOT))
...
void AtomicSwapsDialog::UpdateAssetNameMaxSize()
{
    if (type == IntFromAssetType(AssetType::ROOT) || type == IntFromAssetType(AssetType::QUALIFIER) || type == IntFromAssetType(AssetType::RESTRICTED)) {
...
void AtomicSwapsDialog::UpdateAssetNameToUpper()
{
...
void AtomicSwapsDialog::updateCoinControlState(CCoinControl& ctrl)
{
...
void AtomicSwapsDialog::updateSmartFeeLabel()
{
    if(!model || !model->getOptionsModel())
        return;
...
void AtomicSwapsDialog::coinControlClipboardQuantity()
{
    GUIUtil::setClipboard(ui->labelCoinControlQuantity->text());
}

// Coin Control: copy label "Amount" to clipboard
void AtomicSwapsDialog::coinControlClipboardAmount()
{
    GUIUtil::setClipboard(ui->labelCoinControlAmount->text().left(ui->labelCoinControlAmount->text().indexOf(" ")));
}

// Coin Control: copy label "Fee" to clipboard
void AtomicSwapsDialog::coinControlClipboardFee()
{
    GUIUtil::setClipboard(ui->labelCoinControlFee->text().left(ui->labelCoinControlFee->text().indexOf(" ")).replace(ASYMP_UTF8, ""));
}

// Coin Control: copy label "After fee" to clipboard
void AtomicSwapsDialog::coinControlClipboardAfterFee()
{
    GUIUtil::setClipboard(ui->labelCoinControlAfterFee->text().left(ui->labelCoinControlAfterFee->text().indexOf(" ")).replace(ASYMP_UTF8, ""));
}

// Coin Control: copy label "Bytes" to clipboard
void AtomicSwapsDialog::coinControlClipboardBytes()
{
    GUIUtil::setClipboard(ui->labelCoinControlBytes->text().replace(ASYMP_UTF8, ""));
}

// Coin Control: copy label "Dust" to clipboard
void AtomicSwapsDialog::coinControlClipboardLowOutput()
{
    GUIUtil::setClipboard(ui->labelCoinControlLowOutput->text());
}

// Coin Control: copy label "Change" to clipboard
void AtomicSwapsDialog::coinControlClipboardChange()
{
    GUIUtil::setClipboard(ui->labelCoinControlChange->text().left(ui->labelCoinControlChange->text().indexOf(" ")).replace(ASYMP_UTF8, ""));
}

// Coin Control: settings menu - coin control enabled/disabled by user
void AtomicSwapsDialog::coinControlFeatureChanged(bool checked)
{
...
// Coin Control: settings menu - coin control enabled/disabled by user
void AtomicSwapsDialog::feeControlFeatureChanged(bool checked)
{
    ui->frameFee->setVisible(checked);
}

// Coin Control: button inputs -> show actual coin control dialog
void AtomicSwapsDialog::coinControlButtonClicked()
{
...
void AtomicSwapsDialog::coinControlChangeChecked(int state)
{
...
void AtomicSwapsDialog::coinControlChangeEdited(const QString& text)
{
...
void AtomicSwapsDialog::coinControlUpdateLabels()
{
    if (!model || !model->getOptionsModel())
        return;
...
void AtomicSwapsDialog::minimizeFeeSection(bool fMinimize)
{
...
void AtomicSwapsDialog::on_buttonChooseFee_clicked()
{
    minimizeFeeSection(false);
}

void AtomicSwapsDialog::on_buttonMinimizeFee_clicked()
{
    updateFeeMinimizedLabel();
    minimizeFeeSection(true);
}

void AtomicSwapsDialog::setMinimumFee()
{
    ui->customFee->setValue(GetRequiredFee(1000));
}

void AtomicSwapsDialog::updateFeeSectionControls()
{
...
void AtomicSwapsDialog::updateFeeMinimizedLabel()
{
    if(!model || !model->getOptionsModel())
        return;
...
void AtomicSwapsDialog::updateMinFeeLabel()
{
    if (model && model->getOptionsModel())
...
void AtomicSwapsDialog::setUniqueSelected()
{
...
void AtomicSwapsDialog::setQualifierSelected()
{
    ui->quantitySpinBox->setValue(1);
...
void AtomicSwapsDialog::clearSelected()
{
...
void AtomicSwapsDialog::updateAssetList()
{
    QStringList list;
    list << "";
...
void AtomicSwapsDialog::updateAssetListForRestrictedIssuance()
{
    QStringList list;
    list << "";
...
void AtomicSwapsDialog::updateAssetListForSubQualifierIssuance()
{
    QStringList list;
    list << "";
...
void AtomicSwapsDialog::onClearButtonClicked()
{
    clear();
}

void AtomicSwapsDialog::focusSubAsset(const QModelIndex &index)
{
    selectTypeName(1,index.data(AssetTableModel::AssetNameRole).toString());
}

void AtomicSwapsDialog::focusUniqueAsset(const QModelIndex &index)
{
    selectTypeName(2,index.data(AssetTableModel::AssetNameRole).toString());
}

void AtomicSwapsDialog::selectTypeName(int type, QString name)
{
    clear();
...
void AtomicSwapsDialog::restrictedAssetSelected()
{
...
void AtomicSwapsDialog::restrictedAssetNotSelected()
{
    updateAssetList();
